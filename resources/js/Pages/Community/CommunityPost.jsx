        ...
        <div style={{ maxWidth: 640, margin: '0 auto' }}>
          ...
          <div style={{ padding: '16px', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 2, padding: '8px 0', borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)', marginLeft: -10 }}>
                <button ref={likeBtnRef} onClick={(e) => { if (!post.is_liked_by_me) triggerLikeAnim(e.clientX, e.clientY); handleLike() }} style={{ display: 'flex', alignItems: 'center', gap: 6, background: 'none', border: 'none', cursor: 'pointer', padding: '8px', borderRadius: 999, color: post.is_liked_by_me ? '#EF4444' : 'rgba(255,255,255,0.45)', fontSize: 13, fontWeight: 500 }}>
