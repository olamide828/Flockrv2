...
export default function VideoSeekBar({ videoRef, enabled = true, color = '#FF6B35', onProgress, onSeekStart, onSeekEnd }) {
  ...
  return (
    ...
    >
      <div ref={barRef} style={{ width: '100%', height: engaged ? 6 : 2, background: engaged ? 'rgba(255,255,255,0.28)' : 'rgba(255,255,255,0.15)', transition: 'height 0.18s cubic-bezier(0.34,1.56,0.64,1), background 0.18s ease', position: 'relative' }}>
